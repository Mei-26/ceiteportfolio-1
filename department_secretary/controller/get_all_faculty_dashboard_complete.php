...
function uicard($card_number,$image,$name,$position,$specialization,$contacts,$icon)
{
    ...
    <tr>
        <td width="120px" data-card="'.$card_number.'" class="toggle-btn px-4 cursor-pointer " colspan="3" style="font-size:11px;">' . $name . '</td>
        <td rowspan="4" data-card="'.$card_number.'" class="toggle-btn px-4 cursor-pointer  text-start " style="font-size:11px;">
            ' . $icon . '
        </td>
    </tr>
    <tr>
        <td colspan="3" data-card="'.$card_number.'" class="toggle-btn px-4 cursor-pointer " style="font-size:11px;">' . $position . '</td>
    </tr>
    <tr>
        <td colspan="3" data-card="'.$card_number.'" class="toggle-btn px-4 cursor-pointer " style="font-size:11px;">' . $specialization . '</td>
    </tr>
    <tr>
        <td colspan="3" data-card="'.$card_number.'" class="toggle-btn px-4 cursor-pointer " style="font-size:11px;">' . $contacts . '</td>
    </tr>';
    echo '<tr>
    <td></td>
    <td></td>
